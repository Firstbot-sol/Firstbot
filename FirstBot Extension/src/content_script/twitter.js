...
function showToast(message, position = "bottom-right") {
  ...
  toast.style.fontFamily = "TwitterChirp, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif";
...
function addBloomButtons(element, type = "tweet") {
  try {
    ...
    let parentNode;
    if (type === "tweet") {
      parentNode = element.querySelector('div[data-testid="tweetText"]');
      ...
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        if (node.nodeName.toLowerCase() === "a") {
          ...
          if (match) {
            const address = match[0];
            const bloomButton = createBloomButton(address);
            node.insertAdjacentElement("afterend", bloomButton);
            return;
          }
        }
...
<image id="image0_8_20121" width="72" height="72" xlink:href="data:image/png;base64,"/>
    ...
    bloomButton.appendChild(svgElement);
    ...
    bloomButton.onclick = async (evt) => {
      ...
      const order = await interactWithBloom(null, address, "swap", token, quickBuyAmount, "buy");
